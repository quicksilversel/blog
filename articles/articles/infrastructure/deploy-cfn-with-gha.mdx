...
topics: ['GHA', 'CloudFormation', 'AWS', 'CI/CD']
published: true
date: '2025-07-14'
---
...
This happens because `create-change-set` is asynchronous — it returns instantly while still processing in the background. If you try to execute it right away, CloudFormation throws an error.
...
If you're also automating CloudFormation updates via GitHub Actions, definitely consider waiting before the execution step. It’s a small addition but saved me a lot of debugging time 🔧🚀
