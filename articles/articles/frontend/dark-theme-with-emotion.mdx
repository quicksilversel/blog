...
I use `localStorage` to save their choice, so it persists across sessions. If they haven’t chosen yet, I check their system preference using `window.matchMedia`.
