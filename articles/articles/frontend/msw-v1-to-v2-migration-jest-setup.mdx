...
The handler changes were indeed mechanical. But when I ran `npm test`, everything fell apart. Not because of the API changes, but because of what MSW v2 now expects from the environment it runs in.
