---
title: Integrating BigQuery with Node.js - From Google Sheets to Scalable Data Fetching
description: 'How I migrated from Google Sheets to BigQuery for analytics data in a Node.js application, including authentication, querying, and build-time data generation.'
...
I previously wrote about [solving Google Sheets timeout issues](/articles/fullstack/solving-google-sheets-timeout-buildtime-json) by generating static JSON at build time. While that solved the timeout problem, I still had limitations:
